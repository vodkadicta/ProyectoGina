...
<head>
	<meta charset="UTF-8">
	<title>Samday | Inicio de Sesion</title> 
...
<form class="formulario">
    ...
    <div class="contenedor"> 
         ...
         <br><br>
         <input type="submit" value="Login" class="button"><a href="indexx2.php">login</a>
         <p>Al registrarte, aceptas nuestras Condiciones de uso y Política de privacidad.</p>
         <p>¿No tienes una cuenta? <a class="link" href="registrarvista.php">Registrate </a></p>
         <p>¿Eres administrador?<a class="link" href="loginadministrador.php"> Inicia sesion como administrador</a></p>
     </div>
</form>
